...
wget -O rna_tissue_consensus_v22.zip https://www.proteinatlas.org/download/rna_tissue_consensus.tsv.zip
gunzip -p rna_tissue_consensus_v22.zip > rna_tissue_consensus_v22.tsv
rm rna_tissue_consensus_v22.zip
